      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-5 col-6">
            <img src="http://qb1t0tazy.bkt.clouddn.com/assets/img/theme/light/img-v-4.jpg" alt="Image" class="rounded-lg img-fluid" />
            <div class="text-right mt-4">
              <img src="http://qb1t0tazy.bkt.clouddn.com/assets/img/theme/light/img-1-1000x1000.jpg" alt="Image" class="rounded-lg img-fluid w-50" />
            </div>
          </div>
          <div class="col-lg-7 col-6">
            <img src="http://qb1t0tazy.bkt.clouddn.com/assets/img/theme/light/img-1-1000x800.jpg" alt="Image" class="rounded-lg img-fluid w-75" />
            <div class="text-right mt-4">
              <img src="http://qb1t0tazy.bkt.clouddn.com/assets/img/theme/light/img-2-1000x800.jpg" alt="Image" class="rounded-lg img-fluid" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-lg-3 col-sm-6 mb-5">
            <div data-animate-hover="2">
              <div class="animate-this">
                <a href="#">
                  <img alt="Image placeholder" class="img-fluid rounded shadow" src="http://qb1t0tazy.bkt.clouddn.com/assets/img/theme/light/person-1.jpg">
                </a>
              </div>
              <div class="mt-3">
          ...
          <div class="col-lg-3 col-sm-6 mb-5">
            <div data-animate-hover="2">
              <div class="animate-this">
                <a href="#">
                  <img alt="Image placeholder" class="img-fluid rounded shadow" src="http://qb1t0tazy.bkt.clouddn.com/assets/img/theme/light/person-2.jpg">
                </a>
              </div>
              <div class="mt-3">
          ...
          <div class="col-lg-3 col-sm-6 mb-5">
            <div data-animate-hover="2">
              <div class="animate-this">
                <a href="#">
                  <img alt="Image placeholder" class="img-fluid rounded shadow" src="http://qb1t0tazy.bkt.clouddn.com/assets/img/theme/light/person-3.jpg">
                </a>
              </div>
              <div class="mt-3">
          ...
          <div class="col-lg-3 col-sm-6 mb-5">
            <div data-animate-hover="2">
              <div class="animate-this">
                <a href="#">
                  <img alt="Image placeholder" class="img-fluid rounded shadow" src="http://qb1t0tazy.bkt.clouddn.com/assets/img/theme/light/person-4.jpg">
                </a>
              </div>
              <div class="mt-3">
        ...
        <div class="row">
          <div class="col-lg-3 col-sm-6 mb-5 mb-sm-0">
            <div data-animate-hover="2">
              <div class="animate-this">
                <a href="#">
                  <img alt="Image placeholder" class="img-fluid rounded shadow" src="http://qb1t0tazy.bkt.clouddn.com/assets/img/theme/light/person-5.jpg">
                </a>
              </div>
              <div class="mt-3">
          ...
          <div class="col-lg-3 col-sm-6 mb-5 mb-sm-0">
            <div data-animate-hover="2">
              <div class="animate-this">
                <a href="#">
                  <img alt="Image placeholder" class="img-fluid rounded shadow" src="http://qb1t0tazy.bkt.clouddn.com/assets/img/theme/light/person-6.jpg">
                </a>
              </div>
              <div class="mt-3">
          ...
          <div class="col-lg-3 col-sm-6 mb-5 mb-sm-0">
            <div data-animate-hover="2">
              <div class="animate-this">
                <a href="#">
                  <img alt="Image placeholder" class="img-fluid rounded shadow" src="http://qb1t0tazy.bkt.clouddn.com/assets/img/theme/light/person-7.jpg">
                </a>
              </div>
              <div class="mt-3">
          ...
          <div class="col-lg-3 col-sm-6 mb-0">
            <div data-animate-hover="2">
              <div class="animate-this">
                <a href="#">
                  <img alt="Image placeholder" class="img-fluid rounded shadow" src="http://qb1t0tazy.bkt.clouddn.com/assets/img/theme/light/person-8.jpg">
                </a>
              </div>
              <div class="mt-3">
