      ...
      <div class="container">
        <div class="row row-grid align-items-center">
          <div class="col-12 col-md-5 col-lg-6 order-md-2 text-center">
            <!-- Image -->
            <figure class="w-100">
              <img alt="Image placeholder" src="http://qb1t0tazy.bkt.clouddn.com/assets/img/svg/illustrations/illustration-3.svg" class="img-fluid mw-md-120">
            </figure>
          </div>
        ...
        <div class="row mt-5">
          <div class="col-md-4">
            <div class="card">
              <div class="card-body pb-5">
                <div class="pt-4 pb-5">
                  <img src="http://qb1t0tazy.bkt.clouddn.com/assets/img/svg/illustrations/illustration-5.svg" class="img-fluid img-center" style="height: 150px;" alt="Illustration" />
                </div>
          ...
          <div class="col-md-4">
            <div class="card">
              <div class="card-body pb-5">
                <div class="pt-4 pb-5">
                  <img src="http://qb1t0tazy.bkt.clouddn.com/assets/img/svg/illustrations/illustration-6.svg" class="img-fluid img-center" style="height: 150px;" alt="Illustration" />
                </div>
          ...
          <div class="col-md-4">
            <div class="card">
              <div class="card-body pb-5">
                <div class="pt-4 pb-5">
                  <img src="http://qb1t0tazy.bkt.clouddn.com/assets/img/svg/illustrations/illustration-7.svg" class="img-fluid img-center" style="height: 150px;" alt="Illustration" />
                </div>
            ...
            <div class="col-lg-6 order-lg-1">
              <div class="card mb-0 mr-lg-5">
                <div class="card-body p-2">
                  <img alt="Image placeholder" src="http://qb1t0tazy.bkt.clouddn.com/assets/img/theme/light/screen-1-1000x800.jpg" class="img-fluid shadow rounded">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row row-grid justify-content-between align-items-center">
            ...
            <div class="col-lg-6">
              <div class="card mb-0 ml-lg-5">
                <div class="card-body p-2">
                  <img alt="Image placeholder" src="http://qb1t0tazy.bkt.clouddn.com/assets/img/theme/light/screen-2-1000x800.jpg" class="img-fluid shadow rounded">
                </div>
              </div>
            </div>
          </div>
