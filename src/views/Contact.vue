              ...
              <div class="client-group col">
                <div class="row">
                  <div class="client col-3 py-3">
                    <img alt="Image placeholder" src="http://qb1t0tazy.bkt.clouddn.com/assets/img/clients/svg/google-gray.svg">
                  </div>
                  <div class="client col-3 py-3">
                    <img alt="Image placeholder" src="http://qb1t0tazy.bkt.clouddn.com/assets/img/clients/svg/spotify-gray.svg">
                  </div>
                  <div class="client col-3 py-3">
                    <img alt="Image placeholder" src="http://qb1t0tazy.bkt.clouddn.com/assets/img/clients/svg/airbnb-gray.svg">
                  </div>
                  <div class="client col-3 py-3">
                    <img alt="Image placeholder" src="http://qb1t0tazy.bkt.clouddn.com/assets/img/clients/svg/paypal-gray.svg">
                  </div>
                </div>
              </div>
            </div>
